...
public class ClienteResource {
	...
	public ResponseEntity<Cliente> findByEmailResource(@RequestParam(value = "email") String email) {
	...
	public ResponseEntity<Void> uploadProfilePicture(@RequestParam(value = "multipartFile") MultipartFile multipartFile) {
		URI uri = clienteService.updateProfilePicture(multipartFile);
		return ResponseEntity.created(uri).build();
	}
